...
public class VietNamCalendar {
    ...
    public VietNamCalendar(int day, int month, int year, int timeZone) {
        mDay = day;
        mMonth = month;
        mYear = year;
        mTimeZone = timeZone;
    ...
    public Date ConVertToLunar() {
        ...
        System.out.println("Day: " + mLunarDay);
        System.out.println("mLunarMonth: " + mLunarMonth);
        System.out.println("mLunarYear: " + mLunarYear);
    ...
    public String getLunarMonth() {
        ...
        return can[mod] + " " + chi[mLunarMonth];
    }
    ...
    public String getDateLunar() {
        this.ConVertToLunar();
        return "Là ngày " + this.mLunarDay + " tháng " + this.mLunarMonth + " năm " + this.mLunarYear;
    }


//    public static void main(String[] args) {
//        VietNamCalendar vietNamCalendar = new VietNamCalendar(27, 05, 2019, 7);
//        System.out.println(vietNamCalendar.ConVertToLunar());
//        System.out.println(vietNamCalendar.getDateLunar());
//        System.out.println(vietNamCalendar.getLunarDate());
//        System.out.println(vietNamCalendar.getLunarMonth());
//        System.out.println(vietNamCalendar.getLunarYear());
//    }
